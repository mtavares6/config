  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        -- },
        extensions = {
          ['git_grep'] = { require('telescope').load_extension 'git_grep' },
          ['ui-select'] = {
      ...
      vim.keymap.set('n', '<leader>scc', builtin.git_commits, { desc = '[S] Search Commits}' })
      vim.keymap.set('n', '<leader>scb', builtin.git_bcommits, { desc = '[S] Search Commits Buffer}' })
      vim.keymap.set('n', '<leader>scf', builtin.git_files, { desc = '[S] Search Commit Files' })
      -- Search for the current word and fuzzy-search over the result using git_grep.grep().
      vim.keymap.set({ 'n', 'v' }, '<leader>scg', function()
      ...
      end) -- Slightly advanced example of overriding default behavior and theme
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        dockerls = {},
        robotframework_ls = {
          root_dir = '/opt/homebrew/lib/python3.11/site-packages',
        },
        lua_ls = {
          -- cmd = { ... },
          -- filetypes = { ... },
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      require('mini.surround').setup {
        search_method = 'cover_or_next', -- This expands the search range
      }
